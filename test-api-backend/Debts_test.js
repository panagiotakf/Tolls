...
pm.test("Right format of response",function(){
    ...
    pm.expect(jsonData.Debt).to.be.a('number');
...
if(op1_ID=="olympia_odos"&&op2_ID=="moreas"&&date_from==20201101&&date_to==20201130){
    ...
    pm.test("Olympia owns to Moreas in November 2020 right debt", function () {
        pm.expect(jsonData.Debt).to.eql(2.85);
    });
...
if(op1_ID=="olympia_odos"&&op2_ID=="kentriki_odos"&&date_from==20190201&&date_to==20190228){
    ...
    pm.test("Olympia owns to Kentriki in February 2019 right Dept", function () {
        pm.expect(jsonData.Debt).to.eql(3.4);
    });

}

if(((op1_ID=="aodos"&&op2_ID=="gefyra")||(op1_ID="gefyra"&&op2_ID=="aodos"))&&date_from==20200501&&date_to==20200531){

    pm.test("Gefyra owns to Aodos in May 2020 right dept", function () {
        pm.expect(jsonData.Debt).to.eql(25.2);
    });
...
if(op1_ID=="egnatia"&&op2_ID=="gefyra"&&date_from==20200501&&date_to==20200531){
    ...
    pm.test("Gefyra owns to Egnatia in May 2020 right dept", function () {
        pm.expect(jsonData.Debt).to.eql(2.25);
    });
...
if(op1_ID=="aodos"&&op2_ID=="nea_odos"&&date_from==20210101&&date_to==20210131){
    ...
    pm.test("Nea_odos owns to Aodos in January 2021 right answer", function () {
        pm.expect(jsonData.Debt).to.eql(7.3);
    });
